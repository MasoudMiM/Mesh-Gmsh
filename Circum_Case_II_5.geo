...
//+
surfaceVector_bd_V1[] = Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{surfaceVector_L_1[1]}; Layers{NlayersThickness};Recombine;
};

surfaceVector_bd_V2[] = Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{surfaceVector_bd_V1[0]}; Layers{NlayersThickness};Recombine;
};
...
surfaceVector_L_30[]=Extrude {{0,0,1},{0,0,CrackLoc},Pi/2}{
        Line{3000}; Layers{NlayersThickness};Recombine;
};
...
surfaceVector_d_V3[]=Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{surfaceVector_d_V30[4]}; Layers{NlayersThickness};Recombine;
};
...
surfaceVector_ad_V1[]=Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{surfaceVector_L_4[1]}; Layers{NlayersThickness};Recombine;
};

surfaceVector_ad_V2[]=Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{surfaceVector_ad_V1[0]}; Layers{NlayersThickness};Recombine;
};
